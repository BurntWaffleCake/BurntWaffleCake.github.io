...
export class Polygon {
  ...
  boundsCollide(polygon) {
    return (polygon.pos.x - this.pos.x) ** 2 + (polygon.pos.y - this.pos.y) ** 2 <= (this.radius + polygon.radius) ** 2;
  }
  ...
  toWorldSpace(vector) {
    return new Vector2(this.pos.x + vector.x * Math.cos(this.rot) - vector.y * Math.sin(this.rot), this.pos.y + vector.x * Math.sin(this.rot) + vector.y * Math.cos(this.rot));
  }
...
export class Box extends Polygon {
  constructor(pos = new Vector2(0, 0), size = new Vector2(50, 50), rot = 0, initVel = new Vector2(0, 0), initRotVel = 0) {
    ...
    super([new Vector2(-xHalf, yHalf), new Vector2(xHalf, yHalf), new Vector2(xHalf, -yHalf), new Vector2(-xHalf, -yHalf)], pos, rot, initVel, initRotVel);
